...
describe("Evaluator", () => {
	...
	describe("booleans", () => {
		...
		it("should evaluate logical or", () => {
			expect(evaluate("false || true;")).toEqual({
				type: "boolean",
				value: true,
			});
			expect(evaluate("false || false;")).toEqual({
				type: "boolean",
				value: false,
			});
		});
	...
	describe("strings", () => {
		...
		it("should compare strings", () => {
			expect(evaluate('"abc" == "abc";')).toEqual({
				type: "boolean",
				value: true,
			});
			expect(evaluate('"abc" != "xyz";')).toEqual({
				type: "boolean",
				value: true,
			});
		});
	...
	describe("builtins", () => {
		...
		it("should return type of value", () => {
			expect(evaluate("type(42);")).toEqual({
				type: "string",
				value: "number",
			});
			expect(evaluate('type("hi");')).toEqual({
				type: "string",
				value: "string",
			});
		});
